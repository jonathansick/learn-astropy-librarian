...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("url", type=str, help="URL of the tutorial.")
    parser.add_argument(
        "--index",
        type=str,
    ...
    parser.add_argument(
        "--algolia-id", type=str, help="Algolia application ID"
    )
    parser.add_argument(
        "--algolia-key", type=str, help="Algolia application key"
    )
    parser.add_argument(
        "-l",
        "--log-level",
